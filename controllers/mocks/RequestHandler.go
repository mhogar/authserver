...
// PostToken provides a mock function with given fields: _a0, _a1, _a2
func (_m *RequestHandler) PostToken(_a0 http.ResponseWriter, _a1 *http.Request, _a2 httprouter.Params) {
	_m.Called(_a0, _a1, _a2)
}
